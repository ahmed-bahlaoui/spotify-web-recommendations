import { CompassIcon, Crown, DollarSign, Search } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    background: (
      <img
        className="absolute left-[19%] opacity-90"
        draggable="false"
        src={WavesFrams}
      />
    ),
...
export default function Features() {
  return (
    <div
      className="w-full my-10 flex flex-col  gap-10 items-center justify-center "
      id="features"
    >
      ...
      <BentoGrid className="flex w-full items-center flex-col xl:flex-row  justify-center">
